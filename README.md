...
3. Executer la commande : `pip install -r requirements.txt` à la racine du projet
4. Remplire le fichier de configuration `.env` avec vos information *(Attention le paramettre lang doit être le noms d'un des fichier qui ce trouve ici : `handlebot/ressources/lang`)*
5. Executer la comande : `python start.py`
6. Une fois le bot démarer sur discord effectuer la commande `!ship update` pour inisialiser la BDD
***
### Licence
